    ...
    if request.method == 'POST':
        try:
            ...
            if not data_devolucao_prevista:
                flash(
                    'Data de devolução não informada. O sistema definiu automaticamente.',
                    'info'
                )
            ...
            if not status:
                flash(
                    'Status não informado. O sistema definiu automaticamente como "pendente".',
                    'info'
                )
                status = None
            ...
            cursor.close()
            flash('Erro ao registrar empréstimo: ' + str(e), 'danger')
